...
for row in camisetas:
    rowtxt = ('<td> <a class="linkc" href="#"><img src="{}" alt="Camiseta X" width="422" height="562"></a></td>'.format(row[i]))
...
print('    <link rel="shortcut icon" type="image/x-icon" href="img/skull.ico">')
...
print('        <div class="tl1" id="arrow">v</div>')
print('    </div>')
...
print('                     <div class="row">')
print('                        <a target="_blanck" href="https://www.instagram.com/collarbone_shirts/"></ahref><img src="img/LogoIG.png" ></a>')
print('                        <label>Siguenos en Instagram</label>')
print('                    </div>')
print('                     <div class="row">')
print('                        <a target="_blanck" href="https://www.facebook.com/Collarbone-104201821177244/?modal=admin_todo_tour"><img src="img/LogoFB.png"></a>')
print('                         <label>Siguenos en Facebook</label>')
print('                     </div>')
print('                     <div class="row">')
print('                        <a target="_blanck" href="https://twitter.com/Collarb40200108"><img src="img/LogoTW.png"></a>')
print('                         <label>Siguenos en Twitter</label>')
print('                     </div>')
print('                     <div class="row">')
print('                        <a target="_blanck" href="https://co.pinterest.com/collarboneshirts/"><img src="img/LogoPT.png"></a>')
