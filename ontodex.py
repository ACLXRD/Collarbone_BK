...
print('    <div id="box1">')
print('        <div id="box2">')
print('            <h1><a href="/CollarBone/intodex.html" id="name">Collarbone</a></h1>')
print('        </div>')
print('        <div id="box3">')
print('            <ul id="menu">')
print('                <li><a href="/CollarBone/intodex.html">Inicio</a></li>')
...
print('                <li><a href="#">Perfil</a></li>')
print('                <li><a href="/CollarBone/InicioSesion.html">Salir</a></li>')
print('            </ul>')
print('        </div>')
print('    </div>')
print('    <div id="inicio">')
...
print('        <div class="tl1" id="arrow1">Scrolea!</div>')
print('    </div>')
print('    <h2 id="pregal">Destacadas</h2>')
print('    <div id="update">')
print('        <form action="/cgi-bin/Collarbone_BK/ontodex.py">')
